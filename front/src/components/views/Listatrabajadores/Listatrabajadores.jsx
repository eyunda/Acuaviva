...
const Listatrabajadores = () => {
	...
	const [listatraList, setListatraList] = useState([])
	...
	const init = async () => {
		const { data } = await ApiRequest().get('/listatra')
		setListatraList(data)
	}
	...
	return (
		<>
			...
			<Page title="Acuaviva | Lista Trabajadores">
				<ToastAutoHide message={mensaje} />
				<Container maxWidth='lg'>
					<Box sx={{ pb: 5 }}>
						<Typography variant="h5">Lista de Trabajadores</Typography>
					</Box>
					<Grid container spacing={2}>
						...
						<Grid item xs={12} sm={12}>
							<CommonTable data={listatraList} columns={columns} />
						</Grid>
					</Grid>
				</Container>
			</Page>
