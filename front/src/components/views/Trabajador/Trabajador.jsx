...
const Trabajador = () => {
	...
	const [bodyLogin, setBodyLogin] = useState({ username: '', password: '', nombre: '', id_rol: ''})
	...
	const handleSubmit = () => {
		setIsLoading(true)
		axios.post('http://localhost:4000/api/trabajador', bodyLogin)
			.then(({ data }) => {
	...
	return (
		<Page title="Acuaviva | Trabajadores">
			<ToastAutoHide message={mensaje} />
			<Grid container component="main" sx={{ height: '100vh' }}>
				<CssBaseline />
				<Grid item xs={false} sm={4} md={7}
					sx={{
						backgroundImage: 'url(https://wallpaperstock.net/belize%2c-summer%2c-nature-wallpapers_57716_1366x768.jpg)',
